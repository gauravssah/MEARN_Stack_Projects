...
function Navbar() {
    ...
    return (
        <>
            <div className={`bg-white dark:bg-slate-900 dark:text-white w-full z-50  mx-auto md:px-8 lg:px-20 px-1 sticky  top-0 left-0 right-0 ${sticky ? "sticky-navbar dark:shadow-slate-800 shadow-md  bg-base-200 transition-all ease-in-out" : ""}`}>
                ...
                <div className="navbar  ">
                    <div className="navbar-start">
                        ...
                        <div className="dropdown dark:bg-slate-900 dark:text-white">
                            ...
                            <div tabIndex={0} role="button" className="btn dark:bg-slate-900 dark:text-white btn-ghost lg:hidden">
                                <svg
                            ...
                            <ul
                                ...
                                tabIndex={0}
                                className="menu dark:bg-slate-900 dark:text-white menu-sm dropdown-content bg-base-100 rounded-box z-[1] mt-3 w-52 p-2 shadow">
                    ...
                    <div className="navbar-end">
                        ...
                        {/* Search Box */}
                        <div className='hidden sm:block dark:bg-slate-900 dark:text-white  mr-3'>
