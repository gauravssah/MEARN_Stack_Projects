...
function Banner() {
    return (
        <>
            ...
            <div className="w-[100%] dark:bg-slate-900 dark:text-white lg: lg:w-[98%] text-center md:text-left mx-auto md:px-8 lg:px-20 p-2">
                ...
                <div className='flex flex-col-reverse md:flex-row m-auto  items-center justify-between gap-3'>
                    ...
                    <div className='w-full md:w-1/2'>
                        ...
                        {/* Email Input */}
                        <div className='mt-8 dark:bg-slate-900 dark:text-white dark:border dark:rounded-lg'>
