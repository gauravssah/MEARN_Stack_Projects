...
function Card({ item }) {
    ...
    return (
        <>
            <div className="card bg-base-100 md:w-80 shadow-xl md:mb-5 mb-10">
                <figure>
                    <img
                ...
                <div className="card-body w-full  px-5 ">
                    <h2 className="card-title">
                        {limitText(item.name, 10)} {/* Limit name to 20 characters */}
                        <div className="badge badge-secondary">{item.category}</div>
                    </h2>
                    <p>{limitText(item.title, 52)} {/* Limit title to 60 characters */}</p>
